...
# File uploader for UCI Mall Customers dataset
...
if uploaded_file is not None:
    ...
    df = df[['Annual Income (k$)', 'Spending Score (1-100)', 'Age']]
    ...
    if option == "K-Means Clustering":
        ...
        sns.scatterplot(x=df['Annual Income (k$)'], y=df['Spending Score (1-100)'], 
                        hue=df['KMeans Cluster'], palette='viridis', s=100)
    ...
    st.write("Please upload the UCI dataset to proceed.")
